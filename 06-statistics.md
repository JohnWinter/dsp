...
P(Identical|Twin) = (1/300)*1/(1/125+1/300)
...
Frequentists statistics attempts to create complete objectivity by disregarding prior notions about an experiment while 
Bayesian statistics attempts to include prior notions at the risk of introducing subjectivity and guesswork. 
It seems the consensus is in favor of Bayes statistics as the additional information, if sometimes subjective, has provided
